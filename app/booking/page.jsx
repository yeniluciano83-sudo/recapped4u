...
const TIERS = [
  ...
  { id: "premium", name: "Spotlight", price: "$75", tagline: "Make it unmistakably yours",
    features: ["Unlimited photo uploads", "Shareable + printable QR code & link", "1-week upload deadline", "Every uploaded photo in your gallery", "Full recap video + 5 social cuts, each from a different set of your best photos", "Choose your editing style, plus a separate theme for your social cuts", "Star must-include photos for your video and your social cuts", "Digital delivery", "Downloadable gallery for 4 months", "Add your own photos from your share page", "Close uploads early once everyone's uploaded", "Complimentary Light Roast Reel, +$20 for Lukewarm or Hot"], highlight: true },
