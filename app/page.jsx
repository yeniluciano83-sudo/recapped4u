...
const TIERS = [
  ...
  { id: "keepsake", name: "Luxe", price: "$95", tagline: "The full treatment, built to last",
    features: ["Everything in Signature", "Priority 48-72hr turnaround", "Complimentary Roast Reel add-on", "2-week upload deadline", "Downloadable gallery for 6 months"] },
];
...
const FAQS = [
  ...
  { q: "What happens to our photos after delivery?", a: "Your gallery and video stay accessible for 90 days after delivery (4 months on Signature, 6 months on Luxe). Raw guest uploads are automatically removed 30 days after final delivery to protect your privacy." },
