...
const FAQS = [
  ...
  { q: "What's a social cut?", a: "A short, 60–90 second vertical edit sized for Instagram, TikTok, or Reels. Signature includes one; Luxe includes five, each pulled from a different set of your best photos. On both tiers, your social cut's curation draws from every photo your guests uploaded, not just the ones that made your main video, so it can surface great moments the full cut didn't have room for. By default you get your full recap video plus your social cut(s), but at booking you can swap to social-cuts-only instead — skipping the full video for as many social cuts as it takes to cover every photo guests upload. You can also give your social cut its own editing style, separate from your main video, and star must-include photos for it from your QR share page." },
