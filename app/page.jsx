...
const FAQS = [
  ...
  { q: "Is there a limit on how many guests can upload?", a: "No limit on who can upload — the QR link works for any size gathering, from a small family dinner to a large corporate event. Each event does have a total photo cap: up to 500 uploads on Free and Highlight, up to 2000 on Spotlight and Luxe, which comfortably covers even a large wedding. Free's final gallery is further curated down to the top 20 photos; every paid tier's gallery includes every photo your guests upload, up to that cap." },
