      ...
      <Section id="services" refs={sectionRefs} title="Pricing" icon={<Sparkles size={20} color="#C97A3D" />} band="white"
        ...
        <div style={{ ...cardStyle, marginTop: 16, border: "1.5px solid #C97A3D" }}>
          ...
          <p style={{ fontSize: 13, color: "#4a4642", margin: "0 0 14px", maxWidth: 520 }}>
            Witty, affectionate commentary layered over your photos, and you'll always get a caption-free version of the same video alongside it. Every tier gets Light for free — only Signature and Luxe can turn up the heat to Lukewarm or Hot. Available for any event type.
          </p>
