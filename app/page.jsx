...
const FAQS = [
  ...
  { q: "What's the Roast Reel add-on?", a: "A specialty add-on, on every tier now, that layers witty, affectionate commentary over your photos — every joke sticks to roasting the moment, never a person's appearance — so you get both a captioned cut and a caption-free version of the same video, ready to go. Free and Signature include the Light intensity at no charge; Classic's Light intensity is a $20 add-on; Luxe is complimentary at every intensity. Only Signature and Luxe can go past Light to Lukewarm or Hot (+$20 on Signature). Available for any event type." },
];
      ...
      <Section id="services" refs={sectionRefs} title="Pricing" icon={<Sparkles size={20} color="#C97A3D" />} band="white"
        ...
        <div style={{ ...cardStyle, marginTop: 16, border: "1.5px solid #C97A3D" }}>
          ...
          <p style={{ fontSize: 13, color: "#4a4642", margin: "0 0 14px", maxWidth: 520 }}>
            Witty, affectionate commentary layered over your photos, and you'll always get a caption-free version of the same video alongside it. Every tier gets Light for free (Classic's is a $20 add-on) — only Signature and Luxe can turn up the heat to Lukewarm or Hot. Available for any event type.
          </p>
