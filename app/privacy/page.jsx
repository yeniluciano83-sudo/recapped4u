    ...
    <main style={{ minHeight: "100vh", background: "#FAF7F2", color: HEADING, fontFamily: "var(--font-inter), system-ui, sans-serif" }}>
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "56px 20px 80px" }}>
        ...
        <Section title="How long we keep it">
          ...
          <p><strong style={{ color: HEADING }}>Your delivered gallery and video</strong> stay accessible based on your tier: Free's interactive gallery is available for 7 days after delivery (photos and video stay downloadable after that); Classic for 90 days; Signature for 4 months; Luxe for 6 months.</p>
        ...
        <Section title="Questions">
          <p>Reach us at <a href="mailto:hello@recappedforyou.com" style={{ color: ACCENT, fontWeight: 600, textDecoration: "none" }}>hello@recappedforyou.com</a> or on WhatsApp at <a href="https://wa.me/16465129151" target="_blank" rel="noopener noreferrer" style={{ color: ACCENT, fontWeight: 600, textDecoration: "none" }}>+1 (646) 512-9151</a> if you have questions about your data, or want us to delete something before its normal retention period ends.</p>
        </Section>
      </div>
    </main>
  );
