...
function Section({ title, children }) {
  return (
    <section style={{ marginBottom: 32 }}>
      <h2 style={{ fontFamily: "var(--font-fraunces), Georgia, serif", fontSize: "clamp(19px, 2.1vw, 23px)", color: HEADING, margin: "0 0 10px" }}>{title}</h2>
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#FAF7F2", color: HEADING, fontFamily: "var(--font-inter), system-ui, sans-serif" }}>
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "56px 20px 80px" }}>
        ...
        <h1 style={{ fontFamily: "var(--font-fraunces), Georgia, serif", fontSize: "clamp(28px, 4.2vw, 40px)", margin: "0 0 8px", lineHeight: 1.15 }}>How we handle your data</h1>
        <p style={{ fontSize: 15, color: MUTED, margin: "0 0 4px" }}>Last updated August 2026</p>
        <p style={{ fontSize: 15, color: MUTED, margin: "0 0 12px" }}>Recapped For You LLC, a New York limited liability company, operates this site and the services described here.</p>
        ...
        <Section title="Questions">
          <p>Reach us on WhatsApp (text only) at <a href="https://wa.me/16465129151" target="_blank" rel="noopener noreferrer" style={{ color: ACCENT, fontWeight: 600, textDecoration: "none" }}>+1 (646) 512-9151</a> if you have questions about your data, or want us to delete something before its normal retention period ends.</p>
        </Section>
      </div>
    </main>
  );
