    ...
    return (
      <div style={shellStyle}>
        <div style={{ textAlign: "center", maxWidth: 380 }}>
          ...
          <p style={{ color: "#4a4642", fontSize: 14.5, lineHeight: 1.6 }}>
    ...
    <div style={{ minHeight: "100vh", background: "#FAF7F2", color: "#211F1D", fontFamily: "var(--font-inter), system-ui, sans-serif" }}>
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "48px 20px 100px" }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 14, color: "#4a4642", lineHeight: 1.6, maxWidth: 460, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          {lines.map((l, i) => (
            <div key={i} style={{ background: "#FFFFFF", borderRadius: 14, border: "1px solid #E4DED2", overflow: "hidden", display: "flex", gap: 14, padding: 14 }}>
              <img src={l.photo_url} alt="" style={{ width: 96, height: 96, objectFit: "cover", borderRadius: 10, flexShrink: 0 }} />
              <div style={{ flex: 1 }}>
                <label style={{ fontSize: 11, color: "#6b655c", display: "block", marginBottom: 6, textTransform: "uppercase", letterSpacing: "0.06em" }}>Photo {l.photo_index + 1}</label>
                <textarea
                  value={l.line}
        ...
        <button onClick={handleApprove} disabled={submitting}
          style={{ width: "100%", marginTop: 28, padding: 16, borderRadius: 10, border: "none", background: submitting ? "#E4DED2" : "#C97A3D", color: submitting ? "#8a857d" : "#211F1D", fontSize: 15, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, cursor: submitting ? "default" : "pointer" }}>
