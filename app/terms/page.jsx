  ...
  return (
    <main style={{ minHeight: "100vh", background: "#FAF7F2", color: HEADING, fontFamily: "var(--font-inter), system-ui, sans-serif" }}>
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "56px 20px 80px" }}>
        ...
        <h1 style={{ fontFamily: "var(--font-fraunces), Georgia, serif", fontSize: "clamp(28px, 4.2vw, 40px)", margin: "0 0 8px", lineHeight: 1.15 }}>The fine print</h1>
        ...
        <Section title="What we provide">
          <p>Recapped For You turns photos your event's guests upload into an edited recap video and curated photo gallery. Turnaround times we quote (a few days on Highlight/Spotlight, up to 48 hours on Luxe, Roast Reel included) are estimates, not guarantees — delivery can take longer if guest uploads arrive late or in unusually large volume.</p>
        </Section>
