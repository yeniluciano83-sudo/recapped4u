  ...
  return resend.emails.send({
    ...
    html: wrapEmail(`
        ...
        ${calloutBox(`
          ...
          ${roastEnabled ? detailRow("🔥", "Roast Reel", "Witty commentary layered over your recap video(s). If you have a full recap video, you'll also get a caption-free version of that cut.") : ""}
