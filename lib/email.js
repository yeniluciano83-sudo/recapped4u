...
export async function sendCustomInquiryReceived({ to, hostName, eventType }) {
  return resend.emails.send({
    from: FROM,
    to,
...
export async function sendCustomQuote({ to, hostName, eventType, eventDate, tier, priceFormatted, message, quoteUrl }) {
  return resend.emails.send({
    from: FROM,
    to,
...
export async function sendCustomInquiryReply({ to, hostName, eventType, message, declined }) {
  return resend.emails.send({
    from: FROM,
    to,
