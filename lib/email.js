  ...
  return send({
    ...
    html: wrapEmail(`
        ...
        ${calloutBox(`
          ...
          ${detailRow("/images/how-it-works-icons/pitch-in.jpg", "Send a real invitation", `Your host page has a themed digital invite ready to go — event details and RSVP buttons built right in, matched to your event's own style. Text or WhatsApp delivers the whole picture in one tap, straight from your host page; email works too.`)}
