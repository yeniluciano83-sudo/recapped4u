  ...
  return resend.emails.send({
    ...
    html: wrapEmail(`
        ...
        ${calloutBox(`
          ...
          ${roastEnabled ? detailRow("🔥", "Roast Reel", "Witty commentary layered over your recap video(s). Every roasted cut also comes with a caption-free version alongside it.") : ""}
