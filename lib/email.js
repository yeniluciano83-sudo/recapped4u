  ...
  return send({
    ...
    html: wrapEmail(`
        ...
        ${calloutBox(`
          ...
          ${detailRow("/images/faq-icons/guest-limit.jpg", "Guest uploads", `Open for ${deadline} after your event — anything after that won't make the cut. Add your own photos or close uploads early from your QR share page above.`)}
