...
// Appended to every customer-facing email. No street address included --
// we don't have one on file yet; add one here if that's ever needed for
// compliance (e.g. CAN-SPAM's physical-address requirement).
const LEGAL_FOOTER = `<p style="font-size: 11px; color: #aaa; margin-top: 20px;">Recapped For You LLC, a New York limited liability company.</p>`;
  ...
  return resend.emails.send({
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; color: #211F1D;">
        ...
        <h3 style="font-size: 15px; margin: 0 0 8px;">The details</h3>
        <p style="font-size: 13.5px; color: #444; line-height: 1.6; margin: 0 0 10px;">Guests can upload for ${deadline} after your event, or until you close uploads early from your QR share page — anything after that won't make the cut.</p>
        <p style="font-size: 13.5px; color: #444; line-height: 1.6; margin: 0 0 10px;">Your recap will be delivered by email and stays accessible for ${retention} after delivery. Raw guest uploads are permanently deleted 30 days after final delivery.</p>
        ${roastEnabled ? `<p style="font-size: 13.5px; color: #444; line-height: 1.6; margin: 0 0 10px;">You've added the Roast Reel add-on — nothing is shared with your guests until you've reviewed and approved the full script by email.</p>` : ""}
        <p style="font-size: 13.5px; color: #444; line-height: 1.6; margin: 0 0 10px;">You can cancel any time before your event: more than 24 hours out gets a full refund, within 24 hours isn't eligible since guest uploads may already be underway.</p>
        <p style="font-size: 13.5px; color: #444; line-height: 1.6; margin: 0;">Your and your guests' photos and videos are used only to produce this recap — never sold, shared, or used for advertising.</p>

        <p style="font-size: 12px; color: #999; margin-top: 24px; border-top: 1px solid #eee; padding-top: 16px;">
          By completing your booking and payment, you agreed to these terms. <a href="${cancelUrl}" style="color: #999;">Cancel your booking</a>. Questions? Just reply to this email.
        </p>
        ${LEGAL_FOOTER}
      </div>
    `,
