  ...
  return send({
    ...
    html: wrapEmail(`
        ...
        ${calloutBox(`
          ...
          ${detailRow("/images/how-it-works-icons/pitch-in.jpg", "Send a real invitation", `Skip the group text with a naked QR code screenshot — your host page has a themed digital invite ready to go, RSVP buttons built right in and matched to your event's own style. Text or WhatsApp delivers the whole picture in one tap; email works too.`)}
