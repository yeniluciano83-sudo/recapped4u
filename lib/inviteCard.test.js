...
describe("buildInviteCard", () => {
  ...
  it("drops the RSVP row when showRsvp is false, for the printed poster", async () => {
    // The printed poster (app/qr/[slug]/page.jsx's print-card) gets taped
    // up at the event itself, where "Will you be there?" no longer makes
