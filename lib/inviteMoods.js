...
const INVITE_MOODS = {
  ...
  festive: {
    // muted darkened from #8A857D -- too washed-out for the venue line
    // (and footer text) against this mood's own light cream/white card.
    blobs: ["#E0985A", "#C97A3D"], accent: "#C97A3D", bg: "#FDF3E7", card: "#FFFFFF", text: "#211F1D", muted: "#6B5D4C",
...
// Every mood's background art is a 3D render (see
...
// which is exactly the note the other five moods are leaning into on
